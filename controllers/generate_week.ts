...
export default async function generate_Weeks(practice_calendar: Practices_Timetables) {
    try {
        ...
        const period   = await PeriodModel.findById({_id: practice_calendar.id_period}).exec();
